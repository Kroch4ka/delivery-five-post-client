    ...
    module API
      module V1
        class Cargo < DeliveryFivePostClient::Internal::Type::BaseModel
          ...
          # @!method initialize(height:, length:, price:, product_values:, sender_cargo_id:, weight:, width:, barcode: nil, vat: nil, vendor: nil)
          #   Грузоместо / Cargo
          #
          ...
          #
          #   @param price [Float] Оценочная стоимость грузоместа / Cargo assessed value
          #
          #   @param product_values [Array<DeliveryFivePostClient::Models::API::V1::Partners::Orders::ProductValue>] Товарные позиции в грузоместе / Product values in cargo
          #
