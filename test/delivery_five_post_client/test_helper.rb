...
class DeliveryFivePostClient::Test::SingletonClient < DeliveryFivePostClient::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: DeliveryFivePostClient::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class DeliveryFivePostClient::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @delivery_five_post_client = DeliveryFivePostClient::Test::SingletonClient.instance
  end
