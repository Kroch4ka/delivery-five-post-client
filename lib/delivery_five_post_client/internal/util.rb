    ...
    module Util
      ...
      class << self
        ...
        def coerce_hash!(input)
          ...
          in Hash | nil => coerced
            ...
            message = "Expected a #{Hash} or #{DeliveryFivePostClient::Internal::Type::BaseModel}, got #{data.inspect}"
      ...
      class << self
        ...
        private def write_multipart_chunk(y, boundary:, key:, val:, closing:)
          ...
          case val
          in DeliveryFivePostClient::FilePart unless val.filename.nil?
        ...
        def encode_content(headers, body)
          ...
          in [DeliveryFivePostClient::Internal::Util::JSON_CONTENT, Hash | Array | -> { primitive?(_1) }]
            [headers, JSON.generate(body)]
          in [DeliveryFivePostClient::Internal::Util::JSONL_CONTENT, Enumerable] unless DeliveryFivePostClient::Internal::Type::FileInput === body
            [headers, body.lazy.map { JSON.generate(_1) }]
          in [%r{^multipart/form-data}, Hash | DeliveryFivePostClient::Internal::Type::FileInput]
          ...
          in [_, StringIO]
            [headers, body.string]
          in [_, DeliveryFivePostClient::FilePart]
        ...
        def decode_content(headers, stream:, suppress_error: false)
          ...
          in DeliveryFivePostClient::Internal::Util::JSON_CONTENT
          ...
          in DeliveryFivePostClient::Internal::Util::JSONL_CONTENT
      ...
      module SorbetRuntimeSupport
        ...
        class << self
          # @api private
          #
          # @param type [DeliveryFivePostClient::Internal::Util::SorbetRuntimeSupport, Object]
          #
          # @return [Object]
          def to_sorbet_type(type)
            case type
            in DeliveryFivePostClient::Internal::Util::SorbetRuntimeSupport
              type.to_sorbet_type
            in Class | Module
              type
            in true | false
