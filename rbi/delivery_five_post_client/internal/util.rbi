  ...
  module Internal
    ...
    module Util
      ...
      class << self
        ...
        sig do
          params(url: T.any(URI::Generic, String)).returns(
            DeliveryFivePostClient::Internal::Util::ParsedUri
          )
        end
        def parse_uri(url)
        end
        ...
        sig do
          params(
            parsed: DeliveryFivePostClient::Internal::Util::ParsedUri
          ).returns(URI::Generic)
        end
        ...
        sig do
          params(
            lhs: DeliveryFivePostClient::Internal::Util::ParsedUri,
            rhs: DeliveryFivePostClient::Internal::Util::ParsedUri
          ).returns(URI::Generic)
        end
      ...
      class << self
        # @api private
        sig do
          params(query: DeliveryFivePostClient::Internal::AnyHash).returns(
            DeliveryFivePostClient::Internal::AnyHash
          )
        end
        ...
        sig do
          params(
            collection: DeliveryFivePostClient::Internal::AnyHash,
            key: String,
            element: T.anything
          ).void
        end
      ...
      class << self
        ...
        sig do
          params(lines: T::Enumerable[String]).returns(
            T::Enumerable[
              DeliveryFivePostClient::Internal::Util::ServerSentEvent
            ]
          )
        end
        ...
        class << self
          ...
          sig do
            params(
              type:
                T.any(
                  DeliveryFivePostClient::Internal::Util::SorbetRuntimeSupport,
                  T.anything
                )
            ).returns(T.anything)
          end
