...
```ruby
gem "delivery-five-post-client", git: "https://github.com/Kroch4ka/delivery-five-post-client"
```

Alternatively, reference local copy of the repo:

```bash
$ git clone -- 'https://github.com/Kroch4ka/delivery-five-post-client' '<path-to-repo>'
```
