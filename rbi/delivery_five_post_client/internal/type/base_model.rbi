    ...
    module Type
      class BaseModel
        ...
        class << self
          ...
          sig do
            params(
              child: DeliveryFivePostClient::Internal::Type::BaseModel
            ).void
          end
          def inherited(child)
          end
          ...
          sig do
            returns(
              T::Hash[
                Symbol,
                T.all(
                  DeliveryFivePostClient::Internal::Type::BaseModel::KnownField,
                  {
                    type_fn:
                      T.proc.returns(
        ...
        class << self
          ...
          sig do
            params(
              model: DeliveryFivePostClient::Internal::Type::BaseModel,
              convert: T::Boolean
            ).returns(DeliveryFivePostClient::Internal::AnyHash)
          end
        ...
        sig { overridable.returns(DeliveryFivePostClient::Internal::AnyHash) }
        def to_h
        end
