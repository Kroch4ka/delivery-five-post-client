...
Most of the SDK is generated code. Modifications to code will be persisted between generations, but may result in merge conflicts between manual patches and changes from the generator. The generator will never modify the contents of `lib/delivery_five_post_client/helpers/` and `examples/` directory.
...
require_relative "../lib/delivery_five_post_client"
...
```ruby
gem "delivery-five-post-client", git: "https://github.com/stainless-sdks/delivery-five-post-client-ruby"
```

Alternatively, reference local copy of the repo:

```bash
$ git clone -- 'https://github.com/stainless-sdks/delivery-five-post-client-ruby' '<path-to-repo>'
```

```ruby
gem "delivery-five-post-client", path: "<path-to-repo>"
```
