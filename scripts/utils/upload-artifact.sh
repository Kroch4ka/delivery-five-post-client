...
echo -e "\033[32mInstallation: bundle remove delivery-five-post-client && bundle add delivery-five-post-client --source 'https://pkg.stainless.com/s/delivery-five-post-client-ruby/$SHA'\033[0m"
