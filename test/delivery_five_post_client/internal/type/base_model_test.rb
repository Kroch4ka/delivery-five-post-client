...
class DeliveryFivePostClient::Test::PrimitiveModelTest < Minitest::Test
  A = DeliveryFivePostClient::Internal::Type::ArrayOf[-> { Integer }]
  H = DeliveryFivePostClient::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  module U
    extend DeliveryFivePostClient::Internal::Type::Union
  end

  class B < DeliveryFivePostClient::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      DeliveryFivePostClient::Internal::Type::Unknown,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => DeliveryFivePostClient::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [DeliveryFivePostClient::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [DeliveryFivePostClient::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [DeliveryFivePostClient::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = DeliveryFivePostClient::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        DeliveryFivePostClient::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      ...
      [DeliveryFivePostClient::Internal::Type::Boolean, true] => true,
      [DeliveryFivePostClient::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => DeliveryFivePostClient::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        DeliveryFivePostClient::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = DeliveryFivePostClient::Internal::Type::Converter.new_coerce_state
      DeliveryFivePostClient::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        DeliveryFivePostClient::Internal::Type::Converter.dump(target, input, state: state)
...
class DeliveryFivePostClient::Test::EnumModelTest < Minitest::Test
  class E0
    include DeliveryFivePostClient::Internal::Type::Enum
...
class DeliveryFivePostClient::Test::CollectionModelTest < Minitest::Test
  A1 = DeliveryFivePostClient::Internal::Type::ArrayOf[-> { Integer }]
  H1 = DeliveryFivePostClient::Internal::Type::HashOf[Integer]

  A2 = DeliveryFivePostClient::Internal::Type::ArrayOf[H1]
  H2 = DeliveryFivePostClient::Internal::Type::HashOf[-> { A1 }]

  A3 = DeliveryFivePostClient::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = DeliveryFivePostClient::Internal::Type::HashOf[Integer, nil?: true]
...
class DeliveryFivePostClient::Test::BaseModelTest < Minitest::Test
  class M1 < DeliveryFivePostClient::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < DeliveryFivePostClient::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < DeliveryFivePostClient::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, DeliveryFivePostClient::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = DeliveryFivePostClient::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = DeliveryFivePostClient::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(DeliveryFivePostClient::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue DeliveryFivePostClient::Errors::ConversionError => e
...
class DeliveryFivePostClient::Test::UnionTest < Minitest::Test
  class U0
    include DeliveryFivePostClient::Internal::Type::Union
  ...
  class M2 < DeliveryFivePostClient::Internal::Type::BaseModel
  ...
  class M4 < DeliveryFivePostClient::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, DeliveryFivePostClient::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < DeliveryFivePostClient::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, DeliveryFivePostClient::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class DeliveryFivePostClient::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include DeliveryFivePostClient::Internal::Type::Enum
...
class DeliveryFivePostClient::Test::MetaInfoTest < Minitest::Test
  A1 = DeliveryFivePostClient::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = DeliveryFivePostClient::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
