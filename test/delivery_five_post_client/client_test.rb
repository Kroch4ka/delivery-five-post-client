...
class DeliveryFivePostClientTest < Minitest::Test
  ...
  def test_raises_on_unknown_environment
    e = assert_raises(ArgumentError) do
      DeliveryFivePostClient::Client.new(environment: "wrong")
    end
  ...
  def test_raises_on_missing_non_nullable_opts
    e = assert_raises(ArgumentError) do
      DeliveryFivePostClient::Client.new
    end
    assert_match(/is required/, e.message)
  end

  def test_client_default_request_default_retry_attempts
    stub_request(:post, "http://localhost/api/v1/getLabelStatuses/bySenderOrderIds").to_return_json(
      status: 500,
      body: {}
    )

    delivery_five_post_client =
      DeliveryFivePostClient::Client.new(base_url: "http://localhost", api_key: "My API Key")

    assert_raises(DeliveryFivePostClient::Errors::InternalServerError) do
  ...
  def test_client_given_request_default_retry_attempts
    ...
    delivery_five_post_client =
      DeliveryFivePostClient::Client.new(base_url: "http://localhost", api_key: "My API Key", max_retries: 3)
  ...
  def test_client_retry_after_seconds
    ...
    delivery_five_post_client =
      DeliveryFivePostClient::Client.new(base_url: "http://localhost", api_key: "My API Key", max_retries: 1)
  ...
  def test_client_redirect_307
    ...
    assert_raises(DeliveryFivePostClient::Errors::APIConnectionError) do
      delivery_five_post_client.api.v1.get_label_statuses.by_sender_order_ids(
        sender_order_ids: ["string"],
    ...
    assert_requested(
      ...
      times: DeliveryFivePostClient::Client::MAX_REDIRECTS
    ) do
