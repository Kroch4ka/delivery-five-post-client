    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { DeliveryFivePostClient::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { DeliveryFivePostClient::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            DeliveryFivePostClient::FilePart.new(value)
          in DeliveryFivePostClient::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in DeliveryFivePostClient::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [DeliveryFivePostClient::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: DeliveryFivePostClient::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in DeliveryFivePostClient::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in DeliveryFivePostClient::Internal::Type::Converter
              ...
              DeliveryFivePostClient::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(DeliveryFivePostClient::Internal::Type::Converter, T::Class[T.anything]) }
        end
